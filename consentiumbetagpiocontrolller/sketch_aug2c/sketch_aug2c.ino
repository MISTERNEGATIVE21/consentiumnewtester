...
void loop() {
  ...
  // Extract the sensor information and data
  String sensorInfo = jsonDocument[0]["sensors"][0]["sensorData"][0]["info"].as<String>();
  String sensorId = jsonDocument[0]["sensors"][0]["_id"].as<String>();
  int sensorData = jsonDocument[0]["sensors"][0]["sensorData"][0]["data"].as<int>();
